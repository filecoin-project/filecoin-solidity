...
contract BigIntsTest2 is Test {
    ...
    function test_to_int256_positive() public view {
        CommonTypes.BigInt memory value;
        int256 converted;
        bool isOverflow;
    ...
    function test_to_int256_negative() public view {
        CommonTypes.BigInt memory value;
        int256 converted;
        bool isOverflow;
    ...
    function test_from_uint256() public view {
    ...
    function test_from_int256_positive() public view {
        CommonTypes.BigInt memory converted;
    ...
    function test_from_int256_negative() public view {
        CommonTypes.BigInt memory converted;
    ...
    function test_zero_to_uint256() public {
        CommonTypes.BigInt memory value = CommonTypes.BigInt({val: hex"00", neg: false});

        (uint256 converted, bool isOverflow) = value.toUint256();

        require(converted == 0, "converted value is not 0!");
    }

    function test_zero_to_int256() public {
        CommonTypes.BigInt memory value = CommonTypes.BigInt({val: hex"00", neg: false});

        (int256 converted, bool isOverflow) = value.toInt256();

        require(converted == 0, "converted value is not 0!");
    }

    function test_empty_val_to_uint256() public {
        CommonTypes.BigInt memory value = CommonTypes.BigInt({val: hex"", neg: false});
    ...
    function test_empty_val_to_int256() public {
        CommonTypes.BigInt memory value = CommonTypes.BigInt({val: hex"", neg: false});
